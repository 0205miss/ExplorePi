...
export default async function MigrationPage({ dataobj, transcript }) {
  //circulation
  const now = new Date();
            ...
            <tbody>
              <tr className="border-b border-[#F7E4BE] bg-[#FBF2DE] text-neutral-800">
                ...
                <td className=" px-3 py-2">
                  {Number.parseInt(dataobj.metric.TotalAccount).toLocaleString(
                    "en-US"
                  )}
                </td>
              </tr>
              <tr className="border-b border-[#F7E4BE] bg-[#FBF2DE] text-neutral-800">
                <td className="py-1">
                  <ExplainPopOver title="All Account" content="Only Pioneers" />
                </td>
                <td className=" py-2 font-medium">
              ...
              <tr className="border-b border-[#F7E4BE] bg-[#FBF2DE] text-neutral-800">
                ...
                <td className=" px-3 py-2 text-xs">
                  {Number.parseFloat(dataobj.metric.TotalClaim).toLocaleString(
                    "en-US",
                    {
                      maximumFractionDigits: 7,
                    }
