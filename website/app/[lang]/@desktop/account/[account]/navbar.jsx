...
export default function NavBar({ transcript,lang }){
    ...
    return(
        ...
        <ul className="shadow flex fixed bottom-0 justify-center w-full font-mono overflow-hidden bg-white">
            <Link href={`/${lang}/statistic`} prefetch={false} className='w-1/4'>
                <li>
                    <button 
                    type="button" 
            ...
            <Link href={`/${lang}/explorer`} prefetch={false} className='w-1/4'>            
                <li >
                    <button 
                    type="button" 
                    className={clsx('whitespace-nowrap shadow block py-1 font-semibold text-center w-full overflow-hidden',{
            ...
            <Link href={`/${lang}/stream`} prefetch={false} className='w-1/4'>            
                <li>
                    <button 
                    type="button" 
            ...
            <Link href={`/${lang}/personal`} prefetch={false} className='w-1/4'>            
                <li>
                    <button 
                    type="button" 
                    className={clsx('whitespace-nowrap shadow block py-1 font-semibold text-center w-full overflow-hidden',{
